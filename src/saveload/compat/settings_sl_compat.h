...
const SaveLoadCompat _settings_sl_compat[] = {
	...
	SLC_VAR("difficulty.roadveh_cost_multiplier"),
	SLC_VAR("difficulty.wagon_cost_multiplier"),
	SLC_VAR("difficulty.train_cost_multiplier"),
	SLC_VAR("difficulty.ship_cost_multiplier"),
	SLC_VAR("difficulty.aircraft_cost_multiplier"),
	SLC_VAR("difficulty.roadveh_running_cost_multiplier"),
	SLC_VAR("difficulty.train_steam_running_cost_multiplier"),
	SLC_VAR("difficulty.train_diesel_cost_multiplier"),
	SLC_VAR("difficulty.train_electric_cost_multiplier"),
	SLC_VAR("difficulty.ship_running_cost_multiplier"),
	SLC_VAR("difficulty.aircraft_running_cost_multiplier"),
	SLC_VAR("diff_level"),
	SLC_VAR("game_creation.town_name"),
	SLC_VAR("game_creation.landscape"),
