...
#	define LANDINFOD_LEVEL 1
		...
		Debug(misc, LANDINFOD_LEVEL, "m6     = {:#x}", tile_map.raw(tile).m6);
		Debug(misc, LANDINFOD_LEVEL, "m7     = {:#x}", tile_map.raw(tile).m7);
		Debug(misc, LANDINFOD_LEVEL, "m8     = {:#x}", tile_map.raw(tile).m8);
