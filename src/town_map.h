...
{
	return HasBit(tile_map.get_e(t).house.m7, 0);
}
...
{
	SetBit(tile_map.get_e(t).house.m7, 0);
	SB(tile_map.get_e(t).house.m7, 1, 3, dest);
}
...
{
	return GB(tile_map.get_e(t).house.m7, 1, 3);
}
...
{
	SB(tile_map.get_e(t).house.m7, 0, 4, 0);
}
...
{
	return GB(tile_map.get_e(t).house.m6, 2, 6);
}
...
{
	SB(tile_map.get_e(t).house.m6, 2, 6, pos);
}
...
{
	assert(IsTileType(t, MP_HOUSE));
	SB(tile_map.get_e(t).house.m6, 2, 6, time);
}
